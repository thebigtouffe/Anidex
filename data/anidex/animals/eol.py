...
class API(object):
    ...
    def Page(self, id, images = 3, videos = 0, sounds = 0, \
                maps = 0, text = 0, iucn = False, subjects = 'overview', \
...
class Search(object):
    ...
    def __init__(self, q, page = 1, exact = True, filter_by_taxon_concept_id = '', filter_by_hierarchy_entry_id = '',
        ...
        url = (
            "http://eol.org/api/search/1.0.json?q={0}&page={1}&exact=true&filter_by_taxon_concept_id={3}"
